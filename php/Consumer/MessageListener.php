...
/**
 * Message listener interface for push consumers
 * 
 * Used only for push consumer to process message consumption synchronously
 */
interface MessageListener {
    /**
     * Consume message
     * 
     * @param MessageView $messageView Message view to consume
