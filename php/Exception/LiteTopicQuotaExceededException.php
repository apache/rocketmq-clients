...
/**
 * Exception thrown when lite topic quota is exceeded
 * 
 * This exception indicates that the number of lite topics or messages
 * has exceeded the configured quota limit.
 */
