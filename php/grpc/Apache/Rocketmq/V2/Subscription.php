...
class Subscription extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional int32 lite_subscription_quota = 6;</code>
     */
    protected $lite_subscription_quota = null;
    /**
     * Only lite push consumer
     * Maximum length limit for lite topic
     *
     * Generated from protobuf field <code>optional int32 max_lite_topic_size = 7;</code>
     */
    protected $max_lite_topic_size = null;
     ...
     *           Long-polling timeout for `ReceiveMessageRequest`, which is essential for
     *           push consumer.
     *     @type int $lite_subscription_quota
     *           Only lite push consumer
     *           client-side lite subscription quota limit
     *     @type int $max_lite_topic_size
     *           Only lite push consumer
     *           Maximum length limit for lite topic
     * }
     */
     ...
     * @return int
     */
    public function getLiteSubscriptionQuota()
    {
        return isset($this->lite_subscription_quota) ? $this->lite_subscription_quota : 0;
    }

    public function hasLiteSubscriptionQuota()
    {
        return isset($this->lite_subscription_quota);
    }

    public function clearLiteSubscriptionQuota()
    {
        unset($this->lite_subscription_quota);
    }
     ...
     * @return $this
     */
    public function setLiteSubscriptionQuota($var)
    {
        GPBUtil::checkInt32($var);
        $this->lite_subscription_quota = $var;
    ...
    {
        return isset($this->max_lite_topic_size) ? $this->max_lite_topic_size : 0;
    }

    public function hasMaxLiteTopicSize()
    {
        return isset($this->max_lite_topic_size);
    }

    public function clearMaxLiteTopicSize()
    {
        unset($this->max_lite_topic_size);
    }
     ...
     * @return $this
     */
    public function setMaxLiteTopicSize($var)
    {
        GPBUtil::checkInt32($var);
        $this->max_lite_topic_size = $var;
