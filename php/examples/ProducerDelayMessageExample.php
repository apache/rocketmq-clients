...
// Set delivery timestamp to 10 seconds from now
$deliveryTimestamp = time() + 10;
$ts = new Timestamp();
$ts->setSeconds($deliveryTimestamp);
$ts->setNanos(0);
...
$message->setBody('This is a delay message for Apache RocketMQ');
$message->setSystemProperties($sysProps);

try {
    $result = $producer->send($message);
    echo "Send message successfully, messageId=" . $result['messageId'] . ", deliveryTimestamp=" . $deliveryTimestamp . "\n";
} catch (\Throwable $e) {
