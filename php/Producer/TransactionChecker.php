 ...
 * 
 * Used to determine TransactionResolution when Transaction is not committed or roll-backed in time
 */
interface TransactionChecker {
    /**
     * Server will solve the suspended transactional message by this method.
     * 
     * @param MessageView $messageView Message to determine TransactionResolution
     * @return TransactionResolution The transaction resolution
     */
