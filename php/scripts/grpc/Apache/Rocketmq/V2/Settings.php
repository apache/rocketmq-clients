...
class Settings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .apache.rocketmq.v2.ClientType client_type = 1;</code>
     * @return int one of the values in {@see \Apache\Rocketmq\V2\ClientType}
     */
     ...
     *
     * Generated from protobuf field <code>optional .apache.rocketmq.v2.ClientType client_type = 1;</code>
     * @param int $var one of the values in {@see \Apache\Rocketmq\V2\ClientType}
     * @return $this
     */
     ...
     * @return $this
     */
    public function setAccessPoint(\Apache\Rocketmq\V2\Endpoints|null $var)
    {
     ...
     * @return $this
     */
    public function setBackoffPolicy(\Apache\Rocketmq\V2\RetryPolicy|null $var)
    {
     ...
     * @return $this
     */
    public function setRequestTimeout(\Google\Protobuf\Duration|null $var)
    {
     ...
     * @return $this
     */
    public function setPublishing(\Apache\Rocketmq\V2\Publishing|null $var)
    {
     ...
     * @return $this
     */
    public function setSubscription(\Apache\Rocketmq\V2\Subscription|null $var)
    {
     ...
     * @return $this
     */
    public function setUserAgent(\Apache\Rocketmq\V2\UA|null $var)
    {
        $this->user_agent = $var;
     ...
     * @return $this
     */
    public function setMetric(\Apache\Rocketmq\V2\Metric|null $var)
    {
        $this->metric = $var;
