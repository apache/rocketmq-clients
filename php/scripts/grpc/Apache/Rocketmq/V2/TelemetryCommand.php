...
class TelemetryCommand extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setSettings(\Apache\Rocketmq\V2\Settings|null $var)
    {
     ...
     * @return $this
     */
    public function setThreadStackTrace(\Apache\Rocketmq\V2\ThreadStackTrace|null $var)
    {
     ...
     * @return $this
     */
    public function setVerifyMessageResult(\Apache\Rocketmq\V2\VerifyMessageResult|null $var)
    {
     ...
     * @return $this
     */
    public function setRecoverOrphanedTransactionCommand(\Apache\Rocketmq\V2\RecoverOrphanedTransactionCommand|null $var)
    {
     ...
     * @return $this
     */
    public function setPrintThreadStackTraceCommand(\Apache\Rocketmq\V2\PrintThreadStackTraceCommand|null $var)
    {
     ...
     * @return $this
     */
    public function setVerifyMessageCommand(\Apache\Rocketmq\V2\VerifyMessageCommand|null $var)
    {
     ...
     * @return $this
     */
    public function setReconnectEndpointsCommand(\Apache\Rocketmq\V2\ReconnectEndpointsCommand|null $var)
    {
