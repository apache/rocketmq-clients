...
type AckMessageEntry struct {
	...
	LiteTopic     *string                `protobuf:"bytes,3,opt,name=lite_topic,json=liteTopic,proto3,oneof" json:"lite_topic,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AckMessageEntry) GetLiteTopic() string {
...
func (x *NotifyUnsubscribeLiteCommand) Reset() {
	*x = NotifyUnsubscribeLiteCommand{}
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NotifyUnsubscribeLiteCommand) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotifyUnsubscribeLiteCommand) ProtoMessage() {}

func (x *NotifyUnsubscribeLiteCommand) ProtoReflect() protoreflect.Message {
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotifyUnsubscribeLiteCommand.ProtoReflect.Descriptor instead.
func (*NotifyUnsubscribeLiteCommand) Descriptor() ([]byte, []int) {
...
type TelemetryCommand struct {
	...
	//	*TelemetryCommand_NotifyUnsubscribeLiteCommand
...
func (x *TelemetryCommand) GetNotifyUnsubscribeLiteCommand() *NotifyUnsubscribeLiteCommand {
	if x != nil {
		if x, ok := x.Command.(*TelemetryCommand_NotifyUnsubscribeLiteCommand); ok {
			return x.NotifyUnsubscribeLiteCommand
		}
	}
	return nil
}
...
func (*TelemetryCommand_NotifyUnsubscribeLiteCommand) isTelemetryCommand_Command() {}
...
type ChangeInvisibleDurationRequest struct {
	...
	LiteTopic *string `protobuf:"bytes,6,opt,name=lite_topic,json=liteTopic,proto3,oneof" json:"lite_topic,omitempty"`
...
func (x *RecallMessageResponse) Reset() {
	*x = RecallMessageResponse{}
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecallMessageResponse) Descriptor() ([]byte, []int) {
	return file_apache_rocketmq_v2_service_proto_rawDescGZIP(), []int{40}
}
...
type SyncLiteSubscriptionRequest struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	Action LiteSubscriptionAction `protobuf:"varint,1,opt,name=action,proto3,enum=apache.rocketmq.v2.LiteSubscriptionAction" json:"action,omitempty"`
	...
	OffsetOption  *OffsetOption `protobuf:"bytes,6,opt,name=offset_option,json=offsetOption,proto3,oneof" json:"offset_option,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SyncLiteSubscriptionRequest) Reset() {
	*x = SyncLiteSubscriptionRequest{}
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SyncLiteSubscriptionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncLiteSubscriptionRequest) ProtoMessage() {}

func (x *SyncLiteSubscriptionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncLiteSubscriptionRequest.ProtoReflect.Descriptor instead.
func (*SyncLiteSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_apache_rocketmq_v2_service_proto_rawDescGZIP(), []int{41}
}

func (x *SyncLiteSubscriptionRequest) GetAction() LiteSubscriptionAction {
	if x != nil {
		return x.Action
	}
...
func (x *SyncLiteSubscriptionRequest) GetGroup() *Resource {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *SyncLiteSubscriptionRequest) GetLiteTopicSet() []string {
	if x != nil {
		return x.LiteTopicSet
	}
	return nil
}

func (x *SyncLiteSubscriptionRequest) GetVersion() int64 {
...
func (x *SyncLiteSubscriptionResponse) Reset() {
	*x = SyncLiteSubscriptionResponse{}
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SyncLiteSubscriptionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncLiteSubscriptionResponse) ProtoMessage() {}

func (x *SyncLiteSubscriptionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_apache_rocketmq_v2_service_proto_msgTypes[42]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncLiteSubscriptionResponse.ProtoReflect.Descriptor instead.
func (*SyncLiteSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_apache_rocketmq_v2_service_proto_rawDescGZIP(), []int{42}
}

func (x *SyncLiteSubscriptionResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_apache_rocketmq_v2_service_proto_rawDesc = "" +
	...
	"\n" +
	"lite_topic\x18\x03 \x01(\tH\x00R\tliteTopic\x88\x01\x01B\r\n" +
	"\v_lite_topic\"\xba\x01\n" +
	...
	"\x1breconnect_endpoints_command\x18\b \x01(\v2-.apache.rocketmq.v2.ReconnectEndpointsCommandH\x00R\x19reconnectEndpointsCommand\x12y\n" +
	"\x1fnotify_unsubscribe_lite_command\x18\t \x01(\v20.apache.rocketmq.v2.NotifyUnsubscribeLiteCommandH\x00R\x1cnotifyUnsubscribeLiteCommandB\t\n" +
	"\acommandB\t\n" +
	"\a_status\"c\n" +
	...
	"\x06status\x18\x01 \x01(\v2\x1a.apache.rocketmq.v2.StatusR\x06status\"\xf6\x02\n" +
	...
	"\roffset_option\x18\x06 \x01(\v2 .apache.rocketmq.v2.OffsetOptionH\x01R\foffsetOption\x88\x01\x01B\n" +
	"\n" +
	"\b_versionB\x10\n" +
	"\x0e_offset_option\"R\n" +
	"\x1cSyncLiteSubscriptionResponse\x122\n" +
	"\x06status\x18\x01 \x01(\v2\x1a.apache.rocketmq.v2.StatusR\x06status2\xcc\x0e\n" +
...
var file_apache_rocketmq_v2_service_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_apache_rocketmq_v2_service_proto_goTypes = []any{
	...
	(*NotifyUnsubscribeLiteCommand)(nil),            // 25: apache.rocketmq.v2.NotifyUnsubscribeLiteCommand
	(*TelemetryCommand)(nil),                        // 26: apache.rocketmq.v2.TelemetryCommand
	(*NotifyClientTerminationRequest)(nil),          // 27: apache.rocketmq.v2.NotifyClientTerminationRequest
	(*NotifyClientTerminationResponse)(nil),         // 28: apache.rocketmq.v2.NotifyClientTerminationResponse
	(*ChangeInvisibleDurationRequest)(nil),          // 29: apache.rocketmq.v2.ChangeInvisibleDurationRequest
	(*ChangeInvisibleDurationResponse)(nil),         // 30: apache.rocketmq.v2.ChangeInvisibleDurationResponse
	(*PullMessageRequest)(nil),                      // 31: apache.rocketmq.v2.PullMessageRequest
	(*PullMessageResponse)(nil),                     // 32: apache.rocketmq.v2.PullMessageResponse
	(*UpdateOffsetRequest)(nil),                     // 33: apache.rocketmq.v2.UpdateOffsetRequest
	(*UpdateOffsetResponse)(nil),                    // 34: apache.rocketmq.v2.UpdateOffsetResponse
	(*GetOffsetRequest)(nil),                        // 35: apache.rocketmq.v2.GetOffsetRequest
	(*GetOffsetResponse)(nil),                       // 36: apache.rocketmq.v2.GetOffsetResponse
	(*QueryOffsetRequest)(nil),                      // 37: apache.rocketmq.v2.QueryOffsetRequest
	(*QueryOffsetResponse)(nil),                     // 38: apache.rocketmq.v2.QueryOffsetResponse
	(*RecallMessageRequest)(nil),                    // 39: apache.rocketmq.v2.RecallMessageRequest
	(*RecallMessageResponse)(nil),                   // 40: apache.rocketmq.v2.RecallMessageResponse
	(*SyncLiteSubscriptionRequest)(nil),             // 41: apache.rocketmq.v2.SyncLiteSubscriptionRequest
	(*SyncLiteSubscriptionResponse)(nil),            // 42: apache.rocketmq.v2.SyncLiteSubscriptionResponse
	(*Resource)(nil),                                // 43: apache.rocketmq.v2.Resource
	(*Endpoints)(nil),                               // 44: apache.rocketmq.v2.Endpoints
	(*Status)(nil),                                  // 45: apache.rocketmq.v2.Status
	(*MessageQueue)(nil),                            // 46: apache.rocketmq.v2.MessageQueue
	(*Message)(nil),                                 // 47: apache.rocketmq.v2.Message
	(*Assignment)(nil),                              // 48: apache.rocketmq.v2.Assignment
	(*FilterExpression)(nil),                        // 49: apache.rocketmq.v2.FilterExpression
	(*durationpb.Duration)(nil),                     // 50: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                   // 51: google.protobuf.Timestamp
	(ClientType)(0),                                 // 52: apache.rocketmq.v2.ClientType
	(TransactionResolution)(0),                      // 53: apache.rocketmq.v2.TransactionResolution
	(TransactionSource)(0),                          // 54: apache.rocketmq.v2.TransactionSource
	(*Settings)(nil),                                // 55: apache.rocketmq.v2.Settings
	(QueryOffsetPolicy)(0),                          // 56: apache.rocketmq.v2.QueryOffsetPolicy
	(LiteSubscriptionAction)(0),                     // 57: apache.rocketmq.v2.LiteSubscriptionAction
	(*OffsetOption)(nil),                            // 58: apache.rocketmq.v2.OffsetOption
}
var file_apache_rocketmq_v2_service_proto_depIdxs = []int32{
	43, // 0: apache.rocketmq.v2.QueryRouteRequest.topic:type_name -> apache.rocketmq.v2.Resource
	44, // 1: apache.rocketmq.v2.QueryRouteRequest.endpoints:type_name -> apache.rocketmq.v2.Endpoints
	45, // 2: apache.rocketmq.v2.QueryRouteResponse.status:type_name -> apache.rocketmq.v2.Status
	46, // 3: apache.rocketmq.v2.QueryRouteResponse.message_queues:type_name -> apache.rocketmq.v2.MessageQueue
	47, // 4: apache.rocketmq.v2.SendMessageRequest.messages:type_name -> apache.rocketmq.v2.Message
	45, // 5: apache.rocketmq.v2.SendResultEntry.status:type_name -> apache.rocketmq.v2.Status
	45, // 6: apache.rocketmq.v2.SendMessageResponse.status:type_name -> apache.rocketmq.v2.Status
	3,  // 7: apache.rocketmq.v2.SendMessageResponse.entries:type_name -> apache.rocketmq.v2.SendResultEntry
	43, // 8: apache.rocketmq.v2.QueryAssignmentRequest.topic:type_name -> apache.rocketmq.v2.Resource
	43, // 9: apache.rocketmq.v2.QueryAssignmentRequest.group:type_name -> apache.rocketmq.v2.Resource
	44, // 10: apache.rocketmq.v2.QueryAssignmentRequest.endpoints:type_name -> apache.rocketmq.v2.Endpoints
	45, // 11: apache.rocketmq.v2.QueryAssignmentResponse.status:type_name -> apache.rocketmq.v2.Status
	48, // 12: apache.rocketmq.v2.QueryAssignmentResponse.assignments:type_name -> apache.rocketmq.v2.Assignment
	43, // 13: apache.rocketmq.v2.ReceiveMessageRequest.group:type_name -> apache.rocketmq.v2.Resource
	46, // 14: apache.rocketmq.v2.ReceiveMessageRequest.message_queue:type_name -> apache.rocketmq.v2.MessageQueue
	49, // 15: apache.rocketmq.v2.ReceiveMessageRequest.filter_expression:type_name -> apache.rocketmq.v2.FilterExpression
	50, // 16: apache.rocketmq.v2.ReceiveMessageRequest.invisible_duration:type_name -> google.protobuf.Duration
	50, // 17: apache.rocketmq.v2.ReceiveMessageRequest.long_polling_timeout:type_name -> google.protobuf.Duration
	45, // 18: apache.rocketmq.v2.ReceiveMessageResponse.status:type_name -> apache.rocketmq.v2.Status
	47, // 19: apache.rocketmq.v2.ReceiveMessageResponse.message:type_name -> apache.rocketmq.v2.Message
	51, // 20: apache.rocketmq.v2.ReceiveMessageResponse.delivery_timestamp:type_name -> google.protobuf.Timestamp
	43, // 21: apache.rocketmq.v2.AckMessageRequest.group:type_name -> apache.rocketmq.v2.Resource
	43, // 22: apache.rocketmq.v2.AckMessageRequest.topic:type_name -> apache.rocketmq.v2.Resource
	9,  // 23: apache.rocketmq.v2.AckMessageRequest.entries:type_name -> apache.rocketmq.v2.AckMessageEntry
	45, // 24: apache.rocketmq.v2.AckMessageResultEntry.status:type_name -> apache.rocketmq.v2.Status
	45, // 25: apache.rocketmq.v2.AckMessageResponse.status:type_name -> apache.rocketmq.v2.Status
	11, // 26: apache.rocketmq.v2.AckMessageResponse.entries:type_name -> apache.rocketmq.v2.AckMessageResultEntry
	43, // 27: apache.rocketmq.v2.ForwardMessageToDeadLetterQueueRequest.group:type_name -> apache.rocketmq.v2.Resource
	43, // 28: apache.rocketmq.v2.ForwardMessageToDeadLetterQueueRequest.topic:type_name -> apache.rocketmq.v2.Resource
	45, // 29: apache.rocketmq.v2.ForwardMessageToDeadLetterQueueResponse.status:type_name -> apache.rocketmq.v2.Status
	43, // 30: apache.rocketmq.v2.HeartbeatRequest.group:type_name -> apache.rocketmq.v2.Resource
	52, // 31: apache.rocketmq.v2.HeartbeatRequest.client_type:type_name -> apache.rocketmq.v2.ClientType
	45, // 32: apache.rocketmq.v2.HeartbeatResponse.status:type_name -> apache.rocketmq.v2.Status
	43, // 33: apache.rocketmq.v2.EndTransactionRequest.topic:type_name -> apache.rocketmq.v2.Resource
	53, // 34: apache.rocketmq.v2.EndTransactionRequest.resolution:type_name -> apache.rocketmq.v2.TransactionResolution
	54, // 35: apache.rocketmq.v2.EndTransactionRequest.source:type_name -> apache.rocketmq.v2.TransactionSource
	45, // 36: apache.rocketmq.v2.EndTransactionResponse.status:type_name -> apache.rocketmq.v2.Status
	47, // 37: apache.rocketmq.v2.VerifyMessageCommand.message:type_name -> apache.rocketmq.v2.Message
	47, // 38: apache.rocketmq.v2.RecoverOrphanedTransactionCommand.message:type_name -> apache.rocketmq.v2.Message
	45, // 39: apache.rocketmq.v2.TelemetryCommand.status:type_name -> apache.rocketmq.v2.Status
	55, // 40: apache.rocketmq.v2.TelemetryCommand.settings:type_name -> apache.rocketmq.v2.Settings
	...
	25, // 47: apache.rocketmq.v2.TelemetryCommand.notify_unsubscribe_lite_command:type_name -> apache.rocketmq.v2.NotifyUnsubscribeLiteCommand
	43, // 48: apache.rocketmq.v2.NotifyClientTerminationRequest.group:type_name -> apache.rocketmq.v2.Resource
	45, // 49: apache.rocketmq.v2.NotifyClientTerminationResponse.status:type_name -> apache.rocketmq.v2.Status
	43, // 50: apache.rocketmq.v2.ChangeInvisibleDurationRequest.group:type_name -> apache.rocketmq.v2.Resource
	43, // 51: apache.rocketmq.v2.ChangeInvisibleDurationRequest.topic:type_name -> apache.rocketmq.v2.Resource
	50, // 52: apache.rocketmq.v2.ChangeInvisibleDurationRequest.invisible_duration:type_name -> google.protobuf.Duration
	45, // 53: apache.rocketmq.v2.ChangeInvisibleDurationResponse.status:type_name -> apache.rocketmq.v2.Status
	43, // 54: apache.rocketmq.v2.PullMessageRequest.group:type_name -> apache.rocketmq.v2.Resource
	46, // 55: apache.rocketmq.v2.PullMessageRequest.message_queue:type_name -> apache.rocketmq.v2.MessageQueue
	49, // 56: apache.rocketmq.v2.PullMessageRequest.filter_expression:type_name -> apache.rocketmq.v2.FilterExpression
	50, // 57: apache.rocketmq.v2.PullMessageRequest.long_polling_timeout:type_name -> google.protobuf.Duration
	45, // 58: apache.rocketmq.v2.PullMessageResponse.status:type_name -> apache.rocketmq.v2.Status
	47, // 59: apache.rocketmq.v2.PullMessageResponse.message:type_name -> apache.rocketmq.v2.Message
	43, // 60: apache.rocketmq.v2.UpdateOffsetRequest.group:type_name -> apache.rocketmq.v2.Resource
	46, // 61: apache.rocketmq.v2.UpdateOffsetRequest.message_queue:type_name -> apache.rocketmq.v2.MessageQueue
	45, // 62: apache.rocketmq.v2.UpdateOffsetResponse.status:type_name -> apache.rocketmq.v2.Status
	43, // 63: apache.rocketmq.v2.GetOffsetRequest.group:type_name -> apache.rocketmq.v2.Resource
	46, // 64: apache.rocketmq.v2.GetOffsetRequest.message_queue:type_name -> apache.rocketmq.v2.MessageQueue
	45, // 65: apache.rocketmq.v2.GetOffsetResponse.status:type_name -> apache.rocketmq.v2.Status
	46, // 66: apache.rocketmq.v2.QueryOffsetRequest.message_queue:type_name -> apache.rocketmq.v2.MessageQueue
	56, // 67: apache.rocketmq.v2.QueryOffsetRequest.query_offset_policy:type_name -> apache.rocketmq.v2.QueryOffsetPolicy
	51, // 68: apache.rocketmq.v2.QueryOffsetRequest.timestamp:type_name -> google.protobuf.Timestamp
	45, // 69: apache.rocketmq.v2.QueryOffsetResponse.status:type_name -> apache.rocketmq.v2.Status
	43, // 70: apache.rocketmq.v2.RecallMessageRequest.topic:type_name -> apache.rocketmq.v2.Resource
	45, // 71: apache.rocketmq.v2.RecallMessageResponse.status:type_name -> apache.rocketmq.v2.Status
	57, // 72: apache.rocketmq.v2.SyncLiteSubscriptionRequest.action:type_name -> apache.rocketmq.v2.LiteSubscriptionAction
	43, // 73: apache.rocketmq.v2.SyncLiteSubscriptionRequest.topic:type_name -> apache.rocketmq.v2.Resource
	43, // 74: apache.rocketmq.v2.SyncLiteSubscriptionRequest.group:type_name -> apache.rocketmq.v2.Resource
	58, // 75: apache.rocketmq.v2.SyncLiteSubscriptionRequest.offset_option:type_name -> apache.rocketmq.v2.OffsetOption
	45, // 76: apache.rocketmq.v2.SyncLiteSubscriptionResponse.status:type_name -> apache.rocketmq.v2.Status
	0,  // 77: apache.rocketmq.v2.MessagingService.QueryRoute:input_type -> apache.rocketmq.v2.QueryRouteRequest
	15, // 78: apache.rocketmq.v2.MessagingService.Heartbeat:input_type -> apache.rocketmq.v2.HeartbeatRequest
	2,  // 79: apache.rocketmq.v2.MessagingService.SendMessage:input_type -> apache.rocketmq.v2.SendMessageRequest
	5,  // 80: apache.rocketmq.v2.MessagingService.QueryAssignment:input_type -> apache.rocketmq.v2.QueryAssignmentRequest
	7,  // 81: apache.rocketmq.v2.MessagingService.ReceiveMessage:input_type -> apache.rocketmq.v2.ReceiveMessageRequest
	10, // 82: apache.rocketmq.v2.MessagingService.AckMessage:input_type -> apache.rocketmq.v2.AckMessageRequest
	13, // 83: apache.rocketmq.v2.MessagingService.ForwardMessageToDeadLetterQueue:input_type -> apache.rocketmq.v2.ForwardMessageToDeadLetterQueueRequest
	31, // 84: apache.rocketmq.v2.MessagingService.PullMessage:input_type -> apache.rocketmq.v2.PullMessageRequest
	33, // 85: apache.rocketmq.v2.MessagingService.UpdateOffset:input_type -> apache.rocketmq.v2.UpdateOffsetRequest
	35, // 86: apache.rocketmq.v2.MessagingService.GetOffset:input_type -> apache.rocketmq.v2.GetOffsetRequest
	37, // 87: apache.rocketmq.v2.MessagingService.QueryOffset:input_type -> apache.rocketmq.v2.QueryOffsetRequest
	17, // 88: apache.rocketmq.v2.MessagingService.EndTransaction:input_type -> apache.rocketmq.v2.EndTransactionRequest
	26, // 89: apache.rocketmq.v2.MessagingService.Telemetry:input_type -> apache.rocketmq.v2.TelemetryCommand
	27, // 90: apache.rocketmq.v2.MessagingService.NotifyClientTermination:input_type -> apache.rocketmq.v2.NotifyClientTerminationRequest
	29, // 91: apache.rocketmq.v2.MessagingService.ChangeInvisibleDuration:input_type -> apache.rocketmq.v2.ChangeInvisibleDurationRequest
	39, // 92: apache.rocketmq.v2.MessagingService.RecallMessage:input_type -> apache.rocketmq.v2.RecallMessageRequest
	41, // 93: apache.rocketmq.v2.MessagingService.SyncLiteSubscription:input_type -> apache.rocketmq.v2.SyncLiteSubscriptionRequest
	1,  // 94: apache.rocketmq.v2.MessagingService.QueryRoute:output_type -> apache.rocketmq.v2.QueryRouteResponse
	16, // 95: apache.rocketmq.v2.MessagingService.Heartbeat:output_type -> apache.rocketmq.v2.HeartbeatResponse
	4,  // 96: apache.rocketmq.v2.MessagingService.SendMessage:output_type -> apache.rocketmq.v2.SendMessageResponse
	6,  // 97: apache.rocketmq.v2.MessagingService.QueryAssignment:output_type -> apache.rocketmq.v2.QueryAssignmentResponse
	8,  // 98: apache.rocketmq.v2.MessagingService.ReceiveMessage:output_type -> apache.rocketmq.v2.ReceiveMessageResponse
	12, // 99: apache.rocketmq.v2.MessagingService.AckMessage:output_type -> apache.rocketmq.v2.AckMessageResponse
	14, // 100: apache.rocketmq.v2.MessagingService.ForwardMessageToDeadLetterQueue:output_type -> apache.rocketmq.v2.ForwardMessageToDeadLetterQueueResponse
	32, // 101: apache.rocketmq.v2.MessagingService.PullMessage:output_type -> apache.rocketmq.v2.PullMessageResponse
	34, // 102: apache.rocketmq.v2.MessagingService.UpdateOffset:output_type -> apache.rocketmq.v2.UpdateOffsetResponse
	36, // 103: apache.rocketmq.v2.MessagingService.GetOffset:output_type -> apache.rocketmq.v2.GetOffsetResponse
	38, // 104: apache.rocketmq.v2.MessagingService.QueryOffset:output_type -> apache.rocketmq.v2.QueryOffsetResponse
	18, // 105: apache.rocketmq.v2.MessagingService.EndTransaction:output_type -> apache.rocketmq.v2.EndTransactionResponse
	26, // 106: apache.rocketmq.v2.MessagingService.Telemetry:output_type -> apache.rocketmq.v2.TelemetryCommand
	28, // 107: apache.rocketmq.v2.MessagingService.NotifyClientTermination:output_type -> apache.rocketmq.v2.NotifyClientTerminationResponse
	30, // 108: apache.rocketmq.v2.MessagingService.ChangeInvisibleDuration:output_type -> apache.rocketmq.v2.ChangeInvisibleDurationResponse
	40, // 109: apache.rocketmq.v2.MessagingService.RecallMessage:output_type -> apache.rocketmq.v2.RecallMessageResponse
	42, // 110: apache.rocketmq.v2.MessagingService.SyncLiteSubscription:output_type -> apache.rocketmq.v2.SyncLiteSubscriptionResponse
...
func file_apache_rocketmq_v2_service_proto_init() {
	...
	file_apache_rocketmq_v2_service_proto_msgTypes[27].OneofWrappers = []any{}
	file_apache_rocketmq_v2_service_proto_msgTypes[29].OneofWrappers = []any{}
	file_apache_rocketmq_v2_service_proto_msgTypes[32].OneofWrappers = []any{
		(*PullMessageResponse_Status)(nil),
		(*PullMessageResponse_Message)(nil),
		(*PullMessageResponse_NextOffset)(nil),
	}
	file_apache_rocketmq_v2_service_proto_msgTypes[37].OneofWrappers = []any{}
	file_apache_rocketmq_v2_service_proto_msgTypes[41].OneofWrappers = []any{}
	type x struct{}
