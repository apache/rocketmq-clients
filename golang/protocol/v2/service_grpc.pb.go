...
func (UnimplementedMessagingServiceServer) PullMessage(*PullMessageRequest, grpc.ServerStreamingServer[PullMessageResponse]) error {
	return status.Error(codes.Unimplemented, "method PullMessage not implemented")
}
func (UnimplementedMessagingServiceServer) UpdateOffset(context.Context, *UpdateOffsetRequest) (*UpdateOffsetResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateOffset not implemented")
}
...
func (UnimplementedMessagingServiceServer) SyncLiteSubscription(context.Context, *SyncLiteSubscriptionRequest) (*SyncLiteSubscriptionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SyncLiteSubscription not implemented")
}
