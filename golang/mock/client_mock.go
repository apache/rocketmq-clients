...
// IsEndpointUpdated mocks base method.
func (m *MockisClient) IsEndpointUpdated() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsEndpointUpdated")
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsEndpointUpdated indicates an expected call of IsEndpointUpdated.
func (mr *MockisClientMockRecorder) IsEndpointUpdated() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsEndpointUpdated", reflect.TypeOf((*MockisClient)(nil).IsEndpointUpdated))
}

// SetRequestTimeout mocks base method.
func (m *MockisClient) SetRequestTimeout(timeout time.Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetRequestTimeout", timeout)
}

// SetRequestTimeout indicates an expected call of SetRequestTimeout.
func (mr *MockisClientMockRecorder) SetRequestTimeout(timeout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetRequestTimeout", reflect.TypeOf((*MockisClient)(nil).SetRequestTimeout), timeout)
}
