...
PROTOBUF_LATH_PATH="$HOME"/.m2/repository/com/google/protobuf/
mkdir -p "$HOME"/.m2/repository/com/google
rm -rf "$PROTOBUF_LATH_PATH" >/dev/null 2>&1
docker cp dummy:/home/rocketmq/.m2/repository/com/google/protobuf "$PROTOBUF_LATH_PATH"
