...
class ClientId:
    ...
    def __init__(self):
        ...
        self.__client_id = host_name + ClientId.CLIENT_ID_SEPARATOR + str(process_id) + \
                           ClientId.CLIENT_ID_SEPARATOR + str(self.__client_index) + ClientId.CLIENT_ID_SEPARATOR + base36_time
