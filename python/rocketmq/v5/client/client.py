...
from rocketmq.v5.exception import IllegalArgumentException, IllegalStateException
from rocketmq.v5.log import logger
from rocketmq.v5.model import CallbackResult, CallbackResultType, TopicRouteData
from rocketmq.v5.util import ClientId, ConcurrentMap, MessagingResultChecker, Misc, Signature
...
class Client:
    ...
    def __start_scheduler(self):
        ...
        try:
            ...
            self.__topic_route_scheduler = threading.Thread(target=self.__schedule_update_topic_route_cache,
            ...
            self.__heartbeat_scheduler = threading.Thread(target=self.__schedule_heartbeat,
            ...
            self.__sync_setting_scheduler = threading.Thread(target=self.__schedule_update_setting,
            ...
            self.__clear_idle_rpc_channels_scheduler = threading.Thread(target=self.__schedule_clear_idle_rpc_channels,
