...
import socket
from rocketmq.grpc_protocol import Endpoints, AddressScheme
    ...
    def __parse_endpoints(endpoints_str):
        if len(endpoints_str) == 0:
            ...
            try:
                ...
                endpoints.scheme = ClientConfiguration.__parse_endpoints_scheme_type(ClientConfiguration.__parse_endpoints_prefix(addresses[0].split(":")[0]))
