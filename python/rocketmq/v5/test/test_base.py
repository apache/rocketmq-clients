...
from rocketmq.grpc_protocol.service_pb2 import SendMessageResponse, ReceiveMessageResponse # noqa
...
from rocketmq.grpc_protocol import Resource, Broker, AddressScheme, Endpoints, Permission, MessageType, Status, Code
...
class TestBase:
    ...
    def fake_queue(topic):
        ...
        fake_queue.accept_message_types.extend((MessageType.NORMAL, MessageType.FIFO, MessageType.DELAY, MessageType.TRANSACTION))
