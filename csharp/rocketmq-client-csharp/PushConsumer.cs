...
namespace Org.Apache.Rocketmq
{
    public class PushConsumer : Consumer, IAsyncDisposable, IDisposable
    {
            ...
            : base(clientConfig, consumerGroup)
        {
            ...
            _consumptionExecutor = new LimitedConcurrencyLevelTaskScheduler(consumptionThreadCount);
        ...
        private ConsumeService CreateConsumerService()
        {
            ...
            return new StandardConsumeService(ClientId, _messageListener, _consumptionExecutor, _consumptionCts.Token);
        }
        ...
        {
            _processQueueTable.TryGetValue(mq, out var pq);
            if (pq != null)
            {
                pq.Drop();
                _processQueueTable.TryRemove(mq, out _);
            }
        }
        ...
        {
            var processQueue = new ProcessQueue(this, mq, filterExpression, _receiveMsgCts, _ackMsgCts, _changeInvisibleDurationCts);
