...
public class TLSSystemConfig {
  ...
  public static boolean tlsEnable =
      Boolean.parseBoolean(System.getProperty(SystemProperty.TLS_ENABLE.getName(), "false"));

  /** To determine whether use test mode when initialize TLS context */
  public static boolean tlsTestModeEnable =
      Boolean.parseBoolean(
          System.getProperty(SystemProperty.TLS_TEST_MODE_ENABLE.getName(), "true"));
  ...
  public static String tlsClientTrustCertPath =
      System.getProperty(SystemProperty.TLS_CLIENT_TRUST_CERT_PATH.getName(), null);
  ...
  public static TLSMode tlsMode =
      TLSMode.parse(
          System.getProperty(
              SystemProperty.TLS_SERVER_MODE.getName(), TLSMode.PERMISSIVE.getMode()));
  ...
  public static String tlsConfigFile =
      System.getProperty(
          SystemProperty.TLS_CONFIG_FILE.getName(), "/etc/rocketmq" + "/tls.properties");
}
