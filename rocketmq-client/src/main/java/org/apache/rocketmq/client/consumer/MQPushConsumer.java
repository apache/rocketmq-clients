...
public interface MQPushConsumer extends MQConsumer {
   ...
   *
   * @param subExpression subscription expression.it only support or operation such as "tag1 || tag2
   *     || tag3" <br>
   ...
   *     MessageFilter
   * @param filterClassSource class source code,used UTF-8 file encoding,must be responsible for
   *     your code safety
   */
   ...
   * <p>
   *
   * <p>Choose Tag: {@link MessageSelector#byTag(String)}
   *
   * <p>
   *
   * <p>Choose SQL92: {@link MessageSelector#bySql(String)}
   *
